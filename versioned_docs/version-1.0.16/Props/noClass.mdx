...
This functionality exists so that you can opt out of the default styling of the reactMultiEmail component if they wish. By setting the noClass prop to true, **you can deactivate the default styling and apply their own custom styles.**
